<x-sidebar-layout :title="'Laporan Nilai'" :header="'Laporan Nilai'">
    ...
    <div class="obe-card mb-3">
        <form method="GET" action="{{ route('kaprodi.laporan.index') }}" class="row g-2 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <a href="{{ route('kaprodi.laporan.index') }}" class="btn btn-obe-outline btn-sm w-100">Reset Filter</a>
            </div>
        </form>
    </div>
                    ...
                    @forelse($classrooms as $idx => $classroom)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('kaprodi.laporan.show', $classroom) }}" class="btn btn-sm btn-obe-red" title="Lihat laporan">Lihat</a>
                            </td>
                        </tr>
                    @empty
                        <tr><td colspan="7" class="text-center text-muted py-5"><em>Belum ada kelas pada filter ini.</em></td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
